...
function resultPrintFunction(item) {    //calculates sum and prints result
    ...
    if (x.length == 3){
        ...
        document.getElementById("gameFin").innerHTML = "YOU FAILED!!! THE WORLD HAS ENDED, NO CONTACT POSSIBLE!";
        ...
        document.getElementById("fastesttry").innerHTML += "YOUR FASTEST: " + y.toFixed(2) + " SEC!";
    }
}
